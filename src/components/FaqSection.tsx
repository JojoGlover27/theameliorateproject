...
const faqs = [
  ...
  { q: "Is Synapse anonymous?", a: "Yes, by default. You engage with the platform, our team, and Synapse operations using a generated unique ID, with end-to-end encryption and no profiles created. The only exception is prescribed medication (ART, PrEP, PEP): Ghana Health Service regulations require your treating clinician to hold a name and contact for medication accountability. That information stays with your clinician only, is never shared with the Ameliorate team or any third party, and is not stored on Synapse operations." },
