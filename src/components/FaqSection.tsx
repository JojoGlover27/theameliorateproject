...
const faqs = [
  ...
  { q: "How do I get started?", a: "Download Synapse from the Google Play Store or Apple App Store (coming soon). Create a unique ID during registration, no name, phone, or email required to use the platform. Start exploring services immediately." },
  { q: "Is Synapse anonymous?", a: "Yes. You engage with the platform, our team, and Synapse operations using a Generated Synapse ID, with end-to-end encryption and no profiles created. For prescribed medication (ART, PrEP, PEP), you will speak with a licensed clinician who may ask for a name and a contact number for medication to user accountability, as required by national health programs. These details are collected only by the clinician during your call, are not saved within Synapse, and are never accessible to the Ameliorate team. Synapse itself remains anonymous." },
  ...
  { q: "Who can use Synapse?", a: "Anyone 18+ in Ghana seeking confidential HIV-related support, especially LGBTQI+ individuals, key populations, and other marginalised populations facing stigma or access challenges." },
