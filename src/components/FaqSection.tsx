...
const faqs = [
  ...
  { q: "Is there any cost?", a: "All core services are free during the pilot phase. Future phases may include optional small contributions for sustainability, but access remains barrier-free." },
